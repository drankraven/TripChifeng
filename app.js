const routeDays = [
  {
    ...
    hotel: "达里湖周边住宿（高德真实数据）：\n⭐ 贡格尔河民宿 4.9分(携程) — 达来诺日镇西岗更嘎查，2025开业，用户首选（高德未收录，携程可订）\n🥇 达里湖君悦酒店 4.7分 — 达日罕苏木达日罕街3号\n🥈 碧海银滩度假中心 4.4分 — 南岸景区旁100m（最近湖）\n🥉 达里金账酒店 4.3分 / 草原春饭店 4.3分\n⚡ 镇上 2 个充电桩（云快充+蒙马慢充），但慢充不可靠。建议 D1 经棚补满，镇桩只作备用。",
    charging: "经棚补满！达来诺日镇有 2 个充电桩（云快充+蒙马慢充⚠️），不可完全依赖。达来诺日服务区 G16 有 5 个快充（距镇仅 10km）。今晚省电。",
    stops: ["真寂之寺", "辽上京博物馆", "辽上京遗址公园", "经棚(⭐补满电)", "贡格尔草原", "达里诺尔湖落日", "达来诺日镇(⚡2桩·1慢充⚠️)"]
  },
  {
    day: 2,
    date: "7月8日 周三",
    ...
    charging: "达来诺日服务区 G16 中段补一次电（5 个蒙马快充）；晚上经棚补满（10 个充电桩）。达来诺日镇有 2 个桩但一个是慢充⚠️，不依赖。全程 225 km。",
...
// --- POI Data: 高德 API v5 真实数据（types 参数，含评分/人均）---
const pois = [
  // ⚡ 充电桩（高德 types=011100 过滤充电站）
  { name: "蒙马超级快充(经棚服务区北区)", kind: "charge", lat: 43.2417, lng: 117.4858, day: 1, detail: "G16丹锡高速·经棚服务区。D1快充首选。" },
  { name: "蒙马超级快充(克旗政府东停车场)", kind: "charge", lat: 43.2660, lng: 117.5476, day: 1, detail: "经棚市区·克旗人民政府东。D1/D2备选。" },
  { name: "驴充充充电站(新世纪宾馆)", kind: "charge", lat: 43.2475, lng: 117.5362, day: 2, detail: "经棚镇应昌路新世纪宾馆。D2住宿旁。" },
  { name: "⭐ 达来诺日服务区充电站（G16·5个蒙马快充）", kind: "charge", lat: 43.4222, lng: 116.8264, day: 2, detail: "达达线中段最强补能点。5个快充桩。达里湖→30km。D2顺路必停！" },
  { name: "云快充(达来诺日·将军府宾馆)", kind: "charge", lat: 43.2347, lng: 116.7384, day: 1, detail: "达来诺日镇内。D1住镇上的话可补电。" },
  { name: "⚠️ 蒙马慢充(达日罕乌拉苏木政府)", kind: "charge", lat: 43.2393, lng: 116.7448, day: 1, detail: "达来诺日镇。慢充！仅应急备用，不推荐依赖。" },
  { name: "昆仑网电(赤峰联通公司)", kind: "charge", lat: 42.2599, lng: 118.9324, day: 3, detail: "钢铁街与芳草路交叉口。红山区核心位置。" },
  { name: "星星充电(赤峰博物馆站)", kind: "charge", lat: 42.2474, lng: 118.9012, day: 3, detail: "赤峰博物馆旁。逛完馆可顺便充电。" },
  { name: "特来电(赤峰桥北长联石油)", kind: "charge", lat: 42.3019, lng: 118.9462, day: 3, detail: "赤锡路55号。" },
  { name: "特来电(赤峰高铁站充电站)", kind: "charge", lat: 42.2778, lng: 118.9021, day: 4, detail: "赤峰站东地下停车场。D4出发前补电。" },

  // 🏨 酒店 D1·达来诺日镇（高德真实评分）
  { name: "⭐ 达里湖君悦酒店 · 4.7分", kind: "hotel", lat: 43.2393, lng: 116.7504, day: 1, detail: "达日罕苏木达日罕街3号。达来诺日镇评分最高！D1推荐。" },
  { name: "碧海银滩度假中心 · 4.4分", kind: "hotel", lat: 43.2388, lng: 116.7125, day: 1, detail: "达里湖南岸景区旁100m。最近湖的选择。" },
  { name: "达里金账酒店 · 4.3分", kind: "hotel", lat: 43.2387, lng: 116.7499, day: 1, detail: "达日罕乌拉苏木达日罕路6号。" },
  { name: "草原春饭店·住宿 · 4.3分", kind: "hotel", lat: 43.2406, lng: 116.7468, day: 1, detail: "达日罕乌拉苏木。吃住一体。" },
  { name: "印象达里酒店 · 4.0分", kind: "hotel", lat: 43.2394, lng: 116.7451, day: 1, detail: "达日罕乌拉苏木满都拉街政府东侧。" },
  { name: "💡 贡格尔河民宿 · 4.9分(携程)", kind: "hotel", lat: 43.232, lng: 116.718, day: 1, detail: "达来诺日镇西岗更嘎查西四组81号。2025开业·32评4.9分。高德未收录，携程可订。用户首选！" },

  // 🏨 酒店 D2·经棚镇（高德真实评分）
  { name: "⭐ 星季酒店 · 4.9分", kind: "hotel", lat: 43.2500, lng: 117.5355, day: 2, detail: "经棚镇三特旅业二楼。D2品质首选！" },
  { name: "丽景酒店 · 4.7分", kind: "hotel", lat: 43.2501, lng: 117.5354, day: 2, detail: "经棚镇和谐家园南门。" },
  { name: "格林豪泰智选 · 4.6分", kind: "hotel", lat: 43.2529, lng: 117.5387, day: 2, detail: "应昌路与贡格尔街交叉口。连锁品质。" },
  { name: "育龙宾馆 · 4.6分", kind: "hotel", lat: 43.2459, lng: 117.5285, day: 2, detail: "赛汗街与经锡路交叉口。" },
  { name: "汉庭酒店 · 4.5分", kind: "hotel", lat: 43.2525, lng: 117.5387, day: 2, detail: "应昌路与经五街交叉口。连锁标准。" },
  { name: "吉雅民宿 · 4.5分", kind: "hotel", lat: 43.2466, lng: 117.5343, day: 2, detail: "达尔罕街中医蒙医医院西。特色民宿。" },

  // 🏨 酒店 D3·赤峰红山区（高德真实评分）
  { name: "春城悦术酒店 · 4.8分", kind: "hotel", lat: 42.265, lng: 118.960, day: 3, detail: "昭乌达路14号。近维多利万悦城。" },
  { name: "长城宾馆 · 4.7分", kind: "hotel", lat: 42.264, lng: 118.962, day: 3, detail: "赤峰南站对面。老牌品质。" },
  { name: "坤港酒店 · 4.7分", kind: "hotel", lat: 42.264, lng: 118.958, day: 3, detail: "昭乌达路33号。近市医院。" },
  { name: "鑫港宾馆 · 4.7分", kind: "hotel", lat: 42.263, lng: 118.961, day: 3, detail: "火车站西150米。实惠好选。" },

  // 🍽️ 餐饮 D1·林东镇（高德真实数据）
  { name: "蒙都43°9羊火锅(林东店)", kind: "food", lat: 43.962, lng: 119.392, day: 1, detail: "林东镇。蒙餐火锅。D1午餐推荐。" },
  { name: "天骄把肉城(林东)", kind: "food", lat: 43.964, lng: 119.390, day: 1, detail: "正宗手把肉。D1午餐备选。" },

  // 🍽️ 餐饮 D1·达来诺日镇（高德真实数据）
  { name: "⭐ 蒙古庄园 · 4.3分", kind: "food", lat: 43.239, lng: 116.745, day: 1, detail: "达日罕乌拉苏木。D1晚餐首选！" },
  { name: "曼陀福地饭店 · 4.1分·¥60", kind: "food", lat: 43.240, lng: 116.750, day: 1, detail: "达里湖南岸。全鱼宴。" },
  { name: "草原明珠达里湖饭店 · 3.9分·¥57", kind: "food", lat: 43.239, lng: 116.748, day: 1, detail: "达达线店。华子鱼招牌。" },
  { name: "达根饺子馆 · 3.8分·¥45", kind: "food", lat: 43.237, lng: 116.744, day: 1, detail: "达达线与贡格尔街交叉口。实惠。" },

  // 🍽️ 餐饮 D3·赤峰（高德真实数据）
  { name: "新奥敦奶茶馆 · 4.0分·¥29", kind: "food", lat: 42.258, lng: 118.955, day: 3, detail: "红山区。蒙式奶茶。D3早餐/午餐。" },
  { name: "邱记对夹家常菜 · 3.6分·¥28", kind: "food", lat: 42.259, lng: 118.954, day: 3, detail: "红山区。对夹（赤峰头牌！）必吃。" },
  { name: "郑记对夹手擀面 · 3.3分·¥24", kind: "food", lat: 42.260, lng: 118.956, day: 3, detail: "红山区。对夹备选。" }
];
