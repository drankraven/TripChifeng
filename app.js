const routeDays = [
  ...
  },
  {
    ...
    weatherTip: "早小雨，湖面灰蒙。11 点后转阴——阴天柔光拍草原反而不刺眼。⭐达来诺日服务区（达达线中段）有5个蒙马快充！D2 不再绕热水塘（省 28 km 回头路），石林→热阿线→黄岗梁→经棚一条线。",
    timeline: [
      { time: "07:30", what: "早餐 + 出发", where: "达来诺日镇 / 达里湖边", detail: "简易早餐。出发即上达达线——这是住在达里湖的最大好处！" },
      { time: "08:00", what: "【达达线·精华段】达里诺尔 → 白音敖包 → 巴彦查干 → 阿斯哈图石林", where: "达达线全线 S105 北段", detail: "约 135 km / 4 h（含多停）。今天才是真正的达达线公路旅行。\n\n📍 停：① 08:30 达来诺日服务区（G16·距达里湖 30 km——可顺路补电！5 个蒙马快充桩，停 20 min）② 09:10 白音敖包沙地云杉（距起点 60 km，停车场+卫生间+商店，停 30 min）③ 10:30 巴彦查干弯道群（S弯+牛羊群，停 20 min）④ 11:20 风车阵（数十座风机列阵，停 15 min）" },
    ...
    hotel: "住经棚镇（高德 POI 真实评分）：\n⭐ 星季酒店 4.9分 | 丽景酒店 4.7分 | 格林豪泰智选 4.6分 | 汉庭 4.5分 | 育龙宾馆 4.6分\n经棚镇酒店品质远超达里湖和热水塘，且周围充电桩密集。",
    charging: "达里湖出发电够用；⭐ 好消息：达来诺日服务区（G16·达达线中段）有5个充电桩（蒙马快充）！D2 可在达达线中途补电。晚上经棚再补满。全程 225 km。",
    stops: ["白音敖包(达达线)", "达来诺日服务区(⭐充电)", "弯道/风车阵(达达线)", "阿斯哈图石林", "黄岗梁山顶(热阿线)", "经棚(🏨品质住宿+⚡补能)"]
  },
  {
    day: 3,
    date: "7月9日 周四",
